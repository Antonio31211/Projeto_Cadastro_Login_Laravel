...
<meta name="viewport" content="width=device-width, initial-scale=1.0"> <!--para ficar bem estruturado no mobile-->
...
<div class="login">
    ...
    <form method="post" action="{{route('usuarios.login')}}"> <!------ o action chama a rota do usuario ---------->
	@csrf <!--chave de segurança, o token-->
		<input type="text" name="usuario" placeholder="Seu usuário" required="required" />
